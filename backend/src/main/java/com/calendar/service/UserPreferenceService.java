...
public class UserPreferenceService {
	...
	public String getUserLanguage(String userId) {
		return preferenceRepository.findByUserId(userId).map(UserPreference::getLanguage).orElse("zh-TW");
	}
	...
	public UserPreferenceDTO getUserPreferences(String userId) {
		...
		return new UserPreferenceDTO(pref.getLanguage(), pref.getTheme());
	}
	...
	public UserPreferenceDTO updateUserPreferences(String userId, UserPreferenceDTO dto) {
		...
		return new UserPreferenceDTO(saved.getLanguage(), saved.getTheme());
	}

	// === 驗證方法 ===

	private boolean isValidLanguage(String language) {
		return language != null && (language.equals("zh-TW") || language.equals("en-US") || language.equals("ja-JP"));
	}

	private boolean isValidTheme(String theme) {
		return theme != null && (theme.equals("light") || theme.equals("dark") || theme.equals("system"));
	}
}