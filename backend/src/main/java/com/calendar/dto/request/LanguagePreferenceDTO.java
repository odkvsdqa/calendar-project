...
public class LanguagePreferenceDTO {
	...
	/**
	 * 語言代碼 可選值: zh-TW, en-US, ja-JP
	 */
	@NotBlank(message = "語言代碼不可為空")
	@Pattern(regexp = "^(zh-TW|en-US|ja-JP)$", message = "無效的語言代碼，僅支援: zh-TW, en-US, ja-JP")
	...
	public String toString() {
		return "LanguagePreferenceDTO{" + "language='" + language + '\'' + '}';
	}
}