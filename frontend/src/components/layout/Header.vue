<template>
  <div class="header">
        ...
        <div class="drawer-content">
          ...
          <div class="accordion-item">
            <div class="accordion-header" @click="toggleVenues">
              ...
              <span class="arrow" :class="{ rotated: isVenuesExpanded }"
                >▼</span
              >
            </div>
            ...
            <div v-show="isVenuesExpanded" class="accordion-body">
              <div class="lang-options">
                ...
                >
                  ...
                  <span v-if="subscribedVenueIds.has(venue.id)" class="check"
                    >✓</span
                  >
                </div>
          ...
          <div class="accordion-item">
            <div class="menu-item" @click="openChangePasswordModal">
              ...
              <span class="menu-text">{{ $t("auth.changePassword") }}</span>
            </div>
          </div>

          <!-- 6. 登出 (手機版) -->
          <div class="accordion-item mobile-only-nav">
            <div class="menu-item logout-item" @click="openLogoutModal">
              <span class="menu-icon">🚪</span>
              <span class="menu-text">{{ $t("auth.logout") }}</span>
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div class="confirm-actions">
        <button class="btn-cancel" @click="showVenueConfirmModal = false">
          {{ $t("common.cancel") }}
        </button>
...
const venueModalTitle = computed(() =>
  isSubscribingAction.value
    ...
    : t("venue.unsubscribeConfirmTitle")
);
...
const toggleVenues = () => {
  isVenuesExpanded.value = !isVenuesExpanded.value;
};
const toggleTheme = () => {
...
@media (max-width: 600px) {
  ...
  .btn-logout {
    display: none;
  } /* 手機版隱藏 Header 的登出按鈕，改用 Drawer 裡的 */
}
